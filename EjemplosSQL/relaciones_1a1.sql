...
CREATE TABLE DNI (
  CITIZEN_ID  NUMBER GENERATED BY DEFAULT AS IDENTITY,
...
CREATE TABLE LOCKER (
  ...
  FK_EMPLOYEE  NUMBER(10)    UNIQUE, -- NULL = taquilla libre
  CONSTRAINT PK_LOCKER PRIMARY KEY (LOCKER_ID),
  CONSTRAINT UQ_LOCKER_CODE UNIQUE (CODE),
  CONSTRAINT UQ_LOCKER_EMP UNIQUE (FK_EMPLOYEE),
  CONSTRAINT FK_LOCKER_EMP FOREIGN KEY (FK_EMPLOYEE)
...
INSERT INTO EMPLOYEE (FULL_NAME, HIRED_ON) VALUES ('Raúl Pérez',  TO_DATE('2024-02-15','YYYY-MM-DD'));

-- Taquillas (una libre, dos asignadas)
INSERT INTO LOCKER (CODE, FK_EMPLOYEE) VALUES ('LK-001', 21);  -- asignada a Lucía
INSERT INTO LOCKER (CODE, FK_EMPLOYEE) VALUES ('LK-006', 21);
INSERT INTO LOCKER (CODE, FK_EMPLOYEE) VALUES ('LK-005', 31); -- libre
INSERT INTO LOCKER (CODE, FK_EMPLOYEE) VALUES ('LK-003', 23);  -- asignada a Sofía
